...
#apt-get -y --purge --autoremove --no-install-recommends install task-kde-desktop/sid task-desktop/sid plasma-workspace-wayland dragonplayer plasma-nm sddm-theme-debian-maui
